...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus key_status=DocumentStatus::ACTUAL) const {
        return FindTopDocuments(raw_query,[key_status](int document_id, DocumentStatus status, int rating) { return status == key_status; });
    }
